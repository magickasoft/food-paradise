export const LEMONCELLO_VODKA = {
  metaSeo: {
    ...
    description:
      'Домашний лимончелло на водке — мягкий лимонный ликёр с ярким ароматом и солнечным вкусом. Без чистого спирта и сложной технологии, готовится за 10 дней.',
    keywords: [
      'лимончелло на водке',
      'лимончелло рецепт',
      'лимонная настойка',
  ...
  searchRequests: [
    ...
    'домашний лимончелло без чистого спирта',
    'лимонный ликёр',
