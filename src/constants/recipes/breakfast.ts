...
export const BREAKFAST = [
  {
    ...
    comments: ['Очень вкусно и просто!', 'Идеальный завтрак для занятых утром', 'Спасибо за рецепт!'],
  },
  {
    metaSeo: {
  ...
  },
  {
    metaSeo: {
      ...
      description:
        'Настоящая израильская шакшука — яйца, томленные в густом томатно-перечном соусе с ароматом специй. Простой и вкусный завтрак за 30 минут: три уровня остроты и советы по подаче.',
      keywords: [
        'шакшука',
        'израильская яичница',
        'рецепт шакшуки',
      ...
      'og:title': 'Шакшука — израильская яичница с помидорами и перцем | Пошаговый рецепт с фото',
      'og:description':
    ...
    searchRequests: ['шакшука', 'израильская яичница', 'рецепт шакшуки', 'яичница с томатами', 'восточный завтрак'],
    ...
    historyDescription:
      'Шакшука — классическое блюдо ближневосточной кухни, родом из Северной Африки. В Израиле она стала символом простого и сытного завтрака, объединяющего все слои общества — от уличных кафе Тель-Авива до домашних кухонь. Яйца томятся в густом соусе из помидоров, сладкого перца и специй с копчёной паприкой и тмином. Наш рецепт сохраняет аутентичность, но адаптирован под доступные ингредиенты. Секрет — в медленном тушении овощей и моменте, когда нужно добавить яйца: тогда шакшука получается нежной и ароматной.',
    ...
    tips: [
      'Для средиземноморского вкуса добавьте оливки и немного феты.',
      'Если соус кажется кислым — добавьте чайную ложку мёда.',
      'Лучше готовить в чугунной сковороде: она дольше держит тепло.',
      'Остроту регулируйте количеством перца чили или паприки.',
    ],
    variations: [
      {
        name: 'С баклажанами',
        changes: 'Добавьте 1 нарезанный кубиками баклажан вместе с перцем.',
      },
      {
        name: 'Зелёная шакшука',
        changes: 'Замените помидоры на 300 г шпината и 2 цукини, добавьте немного сливок для мягкости вкуса.',
      },
    ],
  },
  {
...
Это символ турецкого завтрака, солнечное блюдо, которое подают прямо в сковороде. 
Яйца здесь не жарятся, а медленно томятся в ароматном рагу из сладкого перца, помидоров, лука и специй, 
пока не станут шелковистыми и нежными. 
Традиционно менемен едят с теплым хлебом, макая его прямо в соус — просто, душевно и невероятно вкусно.`,

    historyDescription: `Менемен — блюдо с глубоко народными корнями, родом из одноимённого района в окрестностях Измира. 
Первые упоминания о нём относятся к началу XX века, когда фермеры готовили завтрак из доступных продуктов: 
яиц, перцев и спелых помидоров. 
Со временем менемен стал неотъемлемой частью турецкой гастрономической культуры, 
а в кафе Стамбула и Анкары его подают с разными добавками — от сыра фета до колбасы суджук. 
Главное правило остаётся неизменным: нежная текстура, свежие овощи и аромат оливкового масла.`,
    ...
    variations: [
      ...
      },
      {
        ...
        changes: 'Добавьте 1 баклажан и 1 картофелину, нарезанные кубиками, вместе с перцем.',
      },
    ],
  },
]
