...
export const TARTALETKI_S_KURITSEY_I_GRIBAMI = {
  metaSeo: {
    ...
    'og:image': '/optimize/recipes/new-year/tartaletki-s-kuritsey-i-gribami.webp',
    ...
    twitterImage: '/optimize/recipes/new-year/tartaletki-s-kuritsey-i-gribami.webp',
  ...
  comments: [
    { id: '1', name: 'Анна', text: 'Очень сытно и вкусно', rating: 5, avatar: null },
    { id: '2', name: 'Мария', text: 'Гости съели моментально', rating: 4, avatar: null },
    { id: '3', name: 'Иван', text: 'Отличная начинка для тарталеток', rating: 5, avatar: null },
  ],
}
