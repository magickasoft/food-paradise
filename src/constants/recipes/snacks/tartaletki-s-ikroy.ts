...
export const TARTALETKI_S_IKROY = {
  metaSeo: {
    ...
    'og:image': '/optimize/recipes/new-year/tartaletki-s-ikroy.webp',
    twitterTitle: 'Тарталетки с икрой',
    twitterDescription: 'Праздничные тарталетки с красной икрой.',
    twitterImage: '/optimize/recipes/new-year/tartaletki-s-ikroy.webp',
  ...
  comments: [
    { id: '1', name: 'Анна', text: 'Очень красиво смотрятся на столе', rating: 5, avatar: null },
    { id: '2', name: 'Мария', text: 'Гости разобрали первыми', rating: 4, avatar: null },
    { id: '3', name: 'Иван', text: 'Быстро и невероятно вкусно', rating: 5, avatar: null },
  ],
}
