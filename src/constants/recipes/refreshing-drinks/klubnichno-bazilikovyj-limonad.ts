export const KLUBNICHNO_BAZILIKOVYJ_LIMONAD = {
  ...
  img: '/optimize/recipes/refreshingDrinks/klubnichno-bazilikovyj-limonad.webp',
  ...
  historyDescription:
    'Клубнично-базиликовый лимонад вырос из традиции домашних прохладительных напитков, которые готовили из сезонных фруктов, ягод, трав и холодной воды. Сегодня такие напитки ценят за натуральный вкус и гибкость: сладость легко регулировать, а основу можно менять под настроение и время года.',
}
