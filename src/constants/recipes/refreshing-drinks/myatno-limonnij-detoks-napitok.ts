export const MYATNO_LIMONNIJ_DETOKS_NAPITOK = {
  ...
  historyDescription:
    'Мятно-лимонный детокс-напиток вырос из традиции домашних прохладительных напитков, которые готовили из сезонных фруктов, ягод, трав и холодной воды. Сегодня такие напитки ценят за натуральный вкус и гибкость: сладость легко регулировать, а основу можно менять под настроение и время года.',
}
