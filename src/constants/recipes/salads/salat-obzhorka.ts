...
export const SALAT_OBZHORKA = {
  metaSeo: {
    ...
    'og:image': '/optimize/recipes/new-year/salat-obzhorka.webp',
    twitterTitle: 'Салат Обжорка',
    twitterDescription: 'Классический салат «Обжорка» — сытно и по-домашнему.',
    twitterImage: '/optimize/recipes/new-year/salat-obzhorka.webp',
  ...
  key: 'salat-obzhorka',
  name: 'salat-obzhorka',
  img: '/optimize/recipes/new-year/salat-obzhorka.webp',
  title: 'Салат Обжорка',
  ...
  comments: [
    {
      id: '1',
      name: 'Анна',
      text: 'Очень сытный и вкусный салат',
      rating: 5,
      avatar: null,
    },
    {
      id: '2',
      name: 'Мария',
      text: 'Настоящая классика домашних праздников',
      rating: 4,
      avatar: null,
    },
    {
      id: '3',
      name: 'Иван',
      text: 'Гости всегда просят добавку',
      rating: 5,
      avatar: null,
    },
  ],
