export const SALAT_MIMOSA = {
  metaSeo: {
    ...
    'og:image': '/optimize/recipes/new-year/salat-mimosa.webp',
    twitterTitle: 'Салат Мимоза',
    twitterDescription: 'Классический салат «Мимоза» — украшение праздничного стола.',
    twitterImage: '/optimize/recipes/new-year/salat-mimosa.webp',
  ...
  key: 'salat-mimosa',
  name: 'salat-mimosa',
  img: '/optimize/recipes/new-year/salat-mimosa.webp',
  title: 'Салат Мимоза',
