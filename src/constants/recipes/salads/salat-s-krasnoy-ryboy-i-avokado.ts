...
export const SALAT_S_KRASNOY_RYBOY_I_AVOKADO = {
  metaSeo: {
    ...
    'og:image': '/optimize/recipes/new-year/salat-s-krasnoy-ryboy-i-avokado.webp',
    twitterTitle: 'Салат с красной рыбой и авокадо',
    twitterDescription: 'Нежный и изысканный салат с лососем и авокадо.',
    twitterImage: '/optimize/recipes/new-year/salat-s-krasnoy-ryboy-i-avokado.webp',
  ...
  img: '/optimize/recipes/new-year/salat-s-krasnoy-ryboy-i-avokado.webp',
  title: 'Салат с красной рыбой и авокадо',
  ...
  comments: [
    {
      id: '1',
      name: 'Анна',
      text: 'Очень нежный и свежий салат',
      rating: 5,
      avatar: null,
    },
    {
      id: '2',
      name: 'Мария',
      text: 'Идеально смотрится на праздничном столе',
      rating: 4,
      avatar: null,
    },
    {
