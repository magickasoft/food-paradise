export const SELODKA_POD_SHUBOY = {
  metaSeo: {
    ...
    'og:image': '/optimize/recipes/new-year/selodka-pod-shuboy.webp',
    twitterTitle: 'Селёдка под шубой',
    twitterDescription: 'Классическая селёдка под шубой — символ новогоднего стола.',
    twitterImage: '/optimize/recipes/new-year/selodka-pod-shuboy.webp',
  ...
  img: '/optimize/recipes/new-year/selodka-pod-shuboy.webp',
  title: 'Селёдка под шубой',
  ...
  comments: [
    {
      id: '1',
      name: 'Иван',
      text: 'Без этого салата Новый год не Новый год',
      rating: 4,
      avatar: null,
    },
    {
      id: '2',
      name: 'Елена',
      text: 'Всегда готовим заранее — на следующий день ещё вкуснее',
      rating: 5,
      avatar: null,
    },
    {
      id: '3',
      name: 'Мария',
      text: 'Классика, которая никогда не надоедает',
      rating: 4,
      avatar: null,
    },
  ],
