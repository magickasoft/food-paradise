...
export const SALAT_S_YAZYKOM_I_GRIBAMI = {
  metaSeo: {
    ...
    'og:image': '/optimize/recipes/new-year/salat-s-yazykom-i-gribami.webp',
    twitterTitle: 'Салат с языком и грибами',
    twitterDescription: 'Изысканный салат с языком и грибами для праздничного стола.',
    twitterImage: '/optimize/recipes/new-year/salat-s-yazykom-i-gribami.webp',
  ...
  img: '/optimize/recipes/new-year/salat-s-yazykom-i-gribami.webp',
  title: 'Салат с языком и грибами',
  ...
  comments: [
    ...
    },
    {
      id: '2',
      name: 'Мария',
      text: 'Идеально для праздничного стола',
      rating: 4,
      avatar: null,
    },
    {
