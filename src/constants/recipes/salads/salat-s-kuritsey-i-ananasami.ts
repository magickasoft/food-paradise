...
export const SALAT_S_KURITSEY_I_ANANASAMI = {
  metaSeo: {
    ...
    'og:image': '/optimize/recipes/new-year/salat-s-kuritsey-i-ananasami.webp',
    ...
    twitterImage: '/optimize/recipes/new-year/salat-s-kuritsey-i-ananasami.webp',
  ...
  img: '/optimize/recipes/new-year/salat-s-kuritsey-i-ananasami.webp',
  title: 'Салат с курицей и ананасами',
  ...
  comments: [
    {
      id: '1',
      name: 'Анна',
      text: 'Очень нежный и вкусный салат',
      rating: 5,
      avatar: null,
    },
    {
      id: '2',
      name: 'Мария',
      text: 'Любимая классика с детства',
      rating: 4,
      avatar: null,
    },
    {
      id: '3',
      name: 'Иван',
      text: 'Идеально подходит для праздников',
      rating: 5,
      avatar: null,
    },
  ],
