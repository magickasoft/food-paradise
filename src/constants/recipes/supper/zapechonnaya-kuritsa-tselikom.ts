...
export const ZAPECHONNAYA_KURITSA_TSELIKOM = {
  metaSeo: {
    ...
    'og:image': '/optimize/recipes/new-year/zapechonnaya-kuritsa-tselikom.webp',
    twitterTitle: 'Запечённая курица целиком',
    twitterDescription: 'Классическая курица целиком с румяной корочкой.',
    twitterImage: '/optimize/recipes/new-year/zapechonnaya-kuritsa-tselikom.webp',
  ...
  img: '/optimize/recipes/new-year/zapechonnaya-kuritsa-tselikom.webp',
  ...
  comments: [
    { id: '1', name: 'Анна', text: 'Курица получилась очень сочной', rating: 5, avatar: null },
    { id: '2', name: 'Мария', text: 'Идеальное горячее на праздник', rating: 4, avatar: null },
    { id: '3', name: 'Иван', text: 'Готовлю по этому рецепту постоянно', rating: 5, avatar: null },
  ],
}
