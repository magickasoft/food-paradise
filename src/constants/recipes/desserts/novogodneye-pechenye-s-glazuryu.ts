...
export const NOVOGODNEYE_PECHENYE_S_GLAZURYU = {
  metaSeo: {
    ...
    'og:image': '/optimize/recipes/new-year/novogodneye-pechenye-s-glazuryu.webp',
    twitterTitle: 'Новогоднее печенье с глазурью',
    twitterDescription: 'Праздничное печенье, украшенное глазурью.',
    twitterImage: '/optimize/recipes/new-year/novogodneye-pechenye-s-glazuryu.webp',
  ...
  img: '/optimize/recipes/new-year/novogodneye-pechenye-s-glazuryu.webp',
  title: 'Новогоднее печенье с глазурью',
  ...
  comments: [
    {
      id: '1',
      name: 'Анна',
      text: 'Очень ароматное и красивое',
      rating: 5,
      avatar: null,
    },
    { id: '2', name: 'Мария', text: 'Дети были в восторге', rating: 4, avatar: null },
    { id: '3', name: 'Иван', text: 'Идеально для новогоднего настроения', rating: 5, avatar: null },
  ],
}
