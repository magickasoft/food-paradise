...
`,l=t.default.div.withConfig({componentId:"sc-3ce889b2-1"})`
  ...
  aspect-ratio: 1.3 / 1;
  background: #f5f3f3;
`,d=t.default.div.withConfig({componentId:"sc-3ce889b2-2"})`
  display: flex;
  flex-direction: column;
  padding: 12px;
  flex: 1;
...
`,x=t.default.div.withConfig({componentId:"sc-3ce889b2-6"})`
  ...
  align-items: center;
  gap: 4px;
`,g=["Легко","Средне","Сложно"];e.s(["RecipeCard",0,({name:e,img:t,title:n,description:h,time:f,level:b,variant:u="base"})=>(0,i.jsx)(o.Link,{href:{pathname:"/recipe/[name]",params:{name:e}},locale:"ru",style:{textDecoration:"none",color:"inherit"},children:(0,i.jsxs)(s,{variant:u,children:[(0,i.jsx)(l,{variant:u,children:t?(0,i.jsx)(a.default,{src:t,alt:n,fill:!0,style:{objectFit:"cover"},sizes:"220px"}):(0,i.jsx)("div",{style:{width:"100%",height:"100%",color:"#aaa",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"14px",fontWeight:500},children:"Нет изображения"})}),(0,i.jsxs)(d,{children:[(0,i.jsx)(c,{children:n}),(0,i.jsx)(p,{children:h}),(0,i.jsxs)(m,{children:[(0,i.jsxs)(x,{children:[(0,i.jsx)(r.FiClock,{size:14})," ",f," мин"]}),(0,i.jsxs)(x,{children:[(0,i.jsx)(r.FiStar,{size:14,color:"#f6a623"})," ",g[b-1]]})]})]})]})})])},60777,e=>{"use strict";var i=e.i(43476),t=e.i(97053);let a=t.default.div.withConfig({componentId:"sc-64c242a1-0"})`
  display: flex;
  overflow-x: auto;
  gap: 12px;
  padding-bottom: 8px;
...
`,l=t.default.div.withConfig({componentId:"sc-6ea18ef5-2"})`
  padding: 10px;
  padding-top: 100px;
`,d=t.default.h2.withConfig({componentId:"sc-6ea18ef5-3"})`
  margin-bottom: 24px;
  font-size: 24px;
...
`;e.s(["SeasonalCategories",0,()=>(0,i.jsx)(r,{children:(0,i.jsxs)(l,{children:[(0,i.jsx)(d,{children:"СЕЗОННЫЕ КАТЕГОРИИ"}),(0,i.jsx)(s,{children:o.SEASONAL_CATEGORIES_ARR.map(({key:e,...t})=>(0,i.jsx)(a.CategoryCard,{...t,variant:"large"},e))})]})})])},89938,e=>{"use strict";var i=e.i(43476),t=e.i(97053),a=e.i(50506),o=e.i(37828),n=e.i(1958),r=e.i(95631),s=e.i(4529),l=e.i(60777);let d=t.default.section.withConfig({componentId:"sc-5c000b8d-0"})`
  min-height: 300px;
  max-width: 1920px;
  overflow: hidden;
  padding: 0px 100px;
...
`,c=t.default.div.withConfig({componentId:"sc-5c000b8d-1"})`
  padding: 10px;
...
`,m=t.default.div.withConfig({componentId:"sc-5c000b8d-3"})`
  display: flex;
...
`;e.s(["PopularCategories",0,()=>(0,i.jsx)(d,{children:(0,i.jsxs)(c,{children:[(0,i.jsx)(p,{children:"ПОПУЛЯРНЫЕ КАТЕГОРИИ"}),o.CATEGORIES_ARR.map(({name:e,key:t,...o})=>{let s=r.RECIPES_OBJ[e]?.slice(0,10)||[];return(0,i.jsxs)(m,{children:[(0,i.jsx)(x,{children:(0,i.jsx)(n.CategoryCard,{name:e,...o,variant:"slider"},t||e)}),s.length>0&&(0,i.jsx)(l.RecipesScroll,{children:s.map(({key:e,name:t,...o})=>(0,i.jsx)(a.RecipeCard,{name:t,...o},e||t))})]},t||e)})]})})])}]);