...
`,g=i.default.div.withConfig({componentId:"sc-bb5602da-1"})`
  ...
  color: #6b3d08;
`,u=i.default.span.withConfig({componentId:"sc-bb5602da-2"})`
  width: 18px;
  height: 18px;
  display: inline-flex;
  align-items: center;
...
`;function R({children:e}){return(0,a.jsx)(L,{children:e})}var A=e.i(60777),G=e.i(50506);let N=i.default.section.withConfig({componentId:"sc-776cbdbe-0"})`
  ...
  padding: 28px 0 30px;
  padding-bottom: 30px;
`;function V({recipes:e}){return void 0===e||e?.length===0?null:(0,a.jsxs)(N,{children:[(0,a.jsx)(R,{children:"Попробуйте также"}),(0,a.jsx)(A.RecipesScroll,{children:e.map(({key:e,name:i,...n})=>(0,a.jsx)(G.RecipeCard,{name:i,recipeKey:e,...n},e||i))})]})}let Y=i.default.div.withConfig({componentId:"sc-91da13b8-0"})`
...
`;function eu({variations:e}){let i=W(),[n,t]=(0,f.useState)(!1);return((0,f.useEffect)(()=>{t(!i)},[i]),e&&e.length>0)?(0,a.jsxs)(el,{children:[(0,a.jsxs)(eo,{onClick:()=>t(!n),$isOpen:n,children:[(0,a.jsx)(ed,{children:(0,a.jsx)(er,{children:"Вариации"})}),(0,a.jsx)(eg,{$isOpen:n,children:"▼"})]}),(0,a.jsx)(et,{variations:e,isOpen:n})]}):null}let es=i.default.li.withConfig({componentId:"sc-8d123e7c-0"})`
  ...
  font-size: 0.92rem;
  line-height: 1.65;
`;function em({isOpen:e,history:i}){return(0,a.jsx)(a.Fragment,{children:(0,a.jsx)(es,{$isOpen:e,children:i})})}let ec=i.default.section.withConfig({componentId:"sc-5adc3107-0"})`
  width: 100%;
  display: flex;
  flex-direction: column;
  justify-content: center;
...
`,nG=({data:e,recipeName:i})=>{let[n,t]=(0,f.useState)(!0),[l,o]=(0,f.useState)(2),[d,r]=(0,f.useState)(Array.from({length:e.length},()=>!1)),g=(0,eH.useShoppingListStore)(e=>e.addItems),u=e.map(ny),s=e=>{o(Math.max(1,l+e))},m=e=>{let a=(e=>{if(!e.count)return e.gauge;let a="string"==typeof e.count?parseFloat(e.count):e.count;if(Number.isNaN(a))return e.gauge;let i=a/2*l,n=Number.isInteger(i)?i:i.toFixed(1);return`${n} ${e.gauge}`})(e);return e.note?`${a} (${e.note})`:a},c=d.some(e=>e);return(0,a.jsxs)(nb,{children:[(0,a.jsxs)(nw,{onClick:()=>t(!n),children:[(0,a.jsx)(nk,{children:(0,a.jsx)(nv,{children:"Ингредиенты"})}),(0,a.jsx)(nj,{$isOpen:n,children:"▼"})]}),(0,a.jsx)(nC,{$isOpen:n,children:(0,a.jsxs)(nz,{children:[(0,a.jsxs)(nI,{children:[(0,a.jsx)(n$,{children:"Количество порций:"}),(0,a.jsxs)(nS,{children:[(0,a.jsx)(nD,{onClick:()=>s(-1),$disabled:1===l,disabled:1===l,children:"-"}),(0,a.jsx)(nP,{children:l}),(0,a.jsx)(nD,{onClick:()=>s(1),children:"+"})]})]}),(0,a.jsx)(nM,{children:u.map((e,i)=>(0,a.jsxs)(nK,{children:[(0,a.jsxs)(nO,{children:[(0,a.jsx)(nF,{checked:d[i],onChange:()=>{let e;(e=[...d])[i]=!e[i],r(e)}}),(0,a.jsx)(nB,{$checked:d[i],children:d[i]&&(0,a.jsx)(nT,{viewBox:"0 0 24 24",children:(0,a.jsx)("polyline",{points:"20 6 9 17 4 12"})})})]}),(0,a.jsxs)(nE,{children:[(0,a.jsx)(nL,{children:e.name}),(0,a.jsx)(nR,{children:m(e)})]})]},`${e.name}-${e.count??""}-${e.gauge}-${e.note??""}`))}),(0,a.jsx)(nA,{type:"button",$disabled:!c,disabled:!c,onClick:()=>{g(u.reduce((e,a,n)=>(d[n]&&e.push({name:a.name,amount:m(a),recipeName:i}),e),[])),r(Array.from({length:e.length},()=>!1))},children:"Добавить в список покупок"})]})})]})},nN=i.default.div.withConfig({componentId:"sc-f38e5315-0"})`
  margin: 0px;
