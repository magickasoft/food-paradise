...
`,ef=t.default.input.withConfig({componentId:"sc-bf06a306-9"})`
  display: none;
`,ep=({recipe:e})=>{let[t,n]=(0,Z.useState)(0),[o,d]=(0,Z.useState)(null),[a,r]=(0,Z.useState)(""),[c,l]=(0,Z.useState)(!1),[s,f]=(0,Z.useState)(""),p=async e=>{(e.preventDefault(),t&&a.trim())?a.length<5?f("Комментарий должен содержать хотя бы 5 символов."):(f("Спасибо! Ваш отзыв успешно отправлен 💌"),n(0),r(""),l(!1)):f("Пожалуйста, укажите оценку и комментарий.")};return(0,i.jsxs)(et,{children:[(0,i.jsx)(en,{children:"Оцените рецепт"}),(0,i.jsx)(eo,{children:[1,2,3,4,5].map(e=>(0,i.jsx)(ed,{active:e<=(o??t),onClick:()=>n(e),onMouseEnter:()=>d(e),onMouseLeave:()=>d(null),children:(0,i.jsx)(ei,{})},e))}),(0,i.jsxs)(ea,{onSubmit:p,children:[(0,i.jsx)(ef,{type:"hidden",name:"recipe",value:e}),(0,i.jsx)(er,{value:a,onChange:e=>r(e.target.value.slice(0,300)),placeholder:"Ваш комментарий поможет нам сделать рецепт лучше!"}),(0,i.jsxs)(ec,{children:["Осталось ",300-a.length," символов"]}),(0,i.jsx)(el,{type:"submit",disabled:c,children:c?"Отправка...":"Отправить"}),s&&(0,i.jsx)(es,{children:s})]})]})},ex=t.default.div.withConfig({componentId:"sc-ccad5bb6-0"})`
  display: flex;
  flex-direction: column;
  align-items: center;
  margin-top: 40px;
