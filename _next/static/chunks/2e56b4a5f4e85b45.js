...
`,g=t.default.div.withConfig({componentId:"sc-3ce889b2-5"})`
  ...
  -webkit-box-orient: vertical;
  overflow: hidden;
`,m=t.default.div.withConfig({componentId:"sc-3ce889b2-6"})`
  margin-top: auto;
  display: flex;
...
`,x=t.default.div.withConfig({componentId:"sc-3ce889b2-7"})`
  ...
  align-items: center;
  gap: 4px;
`,f=["Легко","Средне","Сложно"];e.s(["RecipeCard",0,({recipeKey:e,img:t,title:o,description:h,time:b,level:u,variant:w="base"})=>(0,i.jsx)(n.Link,{href:{pathname:"/recipe/[name]",params:{name:e}},style:{textDecoration:"none",color:"inherit"},children:(0,i.jsxs)(s,{variant:w,children:[(0,i.jsx)(d,{variant:w,children:t?(0,i.jsx)(a.default,{src:t,alt:o,fill:!0,style:{objectFit:"cover"},sizes:"220px"}):(0,i.jsx)(l,{children:"Нет изображения"})}),(0,i.jsxs)(c,{children:[(0,i.jsx)(p,{children:o}),(0,i.jsx)(g,{children:h}),(0,i.jsxs)(m,{children:[(0,i.jsxs)(x,{children:[(0,i.jsx)(r.FiClock,{size:14})," ",b," мин"]}),(0,i.jsxs)(x,{children:[(0,i.jsx)(r.FiStar,{size:14,color:"#f6a623"})," ",f[u-1]]})]})]})]})})])},60777,e=>{"use strict";var i=e.i(43476),t=e.i(97053);let a=t.default.div.withConfig({componentId:"sc-64c242a1-0"})`
  display: flex;
  overflow-x: auto;
  gap: 16px;
  padding: 4px 0 14px;
...
`,p=t.default.p.withConfig({componentId:"sc-6ea18ef5-4"})`
  ...
  font-size: 0.98rem;
  line-height: 1.65;
`,g=()=>(0,i.jsx)(s,{children:(0,i.jsxs)(l,{children:[(0,i.jsx)(c,{children:"Сезонные категории"}),(0,i.jsx)(p,{children:"Подборки, которые особенно хочется открыть прямо сейчас."}),(0,i.jsx)(d,{children:r.SEASONAL_CATEGORIES_ARR.map(({key:e,...t})=>(0,i.jsx)(o.CategoryCard,{...t,variant:"large"},e))})]})});var m=e.i(50506),x=e.i(37828),f=e.i(95631),h=e.i(60777);let b=t.default.section.withConfig({componentId:"sc-5c000b8d-0"})`
  max-width: 1280px;
  overflow: hidden;
  padding: 0;
  margin: 0 auto 40px;
...
`,R=t.default.div.withConfig({componentId:"sc-c815964a-2"})`
  max-width: 760px;
`,$=t.default.p.withConfig({componentId:"sc-c815964a-3"})`
  margin: 0 0 14px;
  color: #e75e02;
  font-size: 0.84rem;
  font-weight: 800;
