...
`,n=t.default.div.withConfig({componentId:"sc-f6510fb7-1"})`
...
`,o=t.default.div.withConfig({componentId:"sc-f6510fb7-2"})`
  white-space: pre-line;
  font-style: normal;
  font-weight: normal;
  font-size: 16px;
...
`;e.s(["PageWrapper",0,({label:e,text:a,children:t,backgroundColor:l})=>(0,i.jsx)(r,{children:(0,i.jsxs)(s,{backgroundColor:l,children:[e&&(0,i.jsx)(n,{children:e}),a&&(0,i.jsx)(o,{children:a}),t]})})])},5800,37828,e=>{"use strict";e.s(["SEASONAL_CATEGORIES_ARR",0,[{key:"grill",name:"grill",label:"На мангале",img:"/optimize/categories-imgs/grill.webp",color:"#FFE0C2"},{key:"refreshing-drinks",name:"refreshing-drinks",label:"Освежающие напитки",img:"/optimize/categories-imgs/refreshingDrinks.webp",color:"#D7EEF4"},{key:"salads",name:"salads",label:"Салаты",img:"/optimize/categories-imgs/salads.webp",color:"#C1E1C1"}]],5800),e.s(["CATEGORIES_ARR",0,[{key:"breakfast",name:"breakfast",label:"Завтрак",img:"/optimize/categories-imgs/breakfast.webp",color:"#DCE6F2"},{key:"dinner",name:"dinner",label:"Обед",img:"/optimize/categories-imgs/dinner.webp",color:"#E9E4DF"},{key:"supper",name:"supper",label:"Ужин",img:"/optimize/categories-imgs/supper.webp",color:"#D8E0E3"},{key:"healthy",name:"healthy",label:"Здоровая еда",img:"/optimize/categories-imgs/healthy.webp",color:"#D9E7D0"},{key:"salads",name:"salads",label:"Салаты",img:"/optimize/categories-imgs/salads.webp",color:"#C1E1C1"},{key:"snacks",name:"snacks",label:"Закуски",img:"/optimize/categories-imgs/snacks.webp",color:"#ECEBE7"}],"OTHER_CATEGORIES_ARR",0,[{key:"grill",name:"grill",label:"На мангале",img:"/optimize/categories-imgs/grill.webp",color:"#FFD8D8"},{key:"refreshing-drinks",name:"refreshing-drinks",label:"Освежающие напитки",img:"/optimize/categories-imgs/refreshingDrinks.webp",color:"#ECEBE7"}]],37828)},1958,e=>{"use strict";var i=e.i(43476),a=e.i(97053),t=e.i(20133);let r={large:"250px",medium:"220px",small:"180px",slider:"290px"},n=a.default.div.withConfig({componentId:"sc-f5fb13c4-0"})`
...
`,o=a.default.div.withConfig({componentId:"sc-f5fb13c4-1"})`
...
`;e.s(["CategoryCard",0,({img:e,label:a,color:r,name:s,variant:l="large",backgroundSize:d="cover"})=>(0,i.jsx)(t.Link,{href:{pathname:"/categories/[name]",params:{name:s}},style:{textDecoration:"none"},children:(0,i.jsx)(n,{role:"link",color:r,variant:l,bgimage:e||void 0,bgsize:d,children:(0,i.jsx)(o,{className:"card-title",variant:l,children:a})})})])},81055,e=>{"use strict";var i=e.i(43476),a=e.i(97053),t=e.i(4529),r=e.i(5800),n=e.i(37828),o=e.i(1958),s=e.i(41582);let l=a.default.section.withConfig({componentId:"sc-69ffab43-0"})`
  max-width: 1280px;
  margin: 0 auto 56px;
  padding: 24px 0 0;
...
`,d=a.default.header.withConfig({componentId:"sc-69ffab43-1"})`
  max-width: 780px;
  margin-bottom: 42px;
`,p=a.default.h1.withConfig({componentId:"sc-69ffab43-2"})`
  margin: 0 0 14px;
  color: #211a15;
...
`,m=a.default.div.withConfig({componentId:"sc-69ffab43-4"})`
  display: flex;
  flex-direction: column;
  gap: 44px;
...
`;e.s(["default",0,()=>{let e=n.OTHER_CATEGORIES_ARR.filter(e=>"grill"!==e.key);return(0,i.jsx)(s.PageWrapper,{children:(0,i.jsxs)(l,{children:[(0,i.jsxs)(d,{children:[(0,i.jsx)(p,{children:"Категории рецептов"}),(0,i.jsx)(c,{children:"Выберите настроение, сезон или формат блюда: от быстрых завтраков до рецептов на мангале и домашних напитков."})]}),(0,i.jsxs)(m,{children:[(0,i.jsxs)(g,{children:[(0,i.jsx)(x,{children:"Сезонное"}),(0,i.jsx)(f,{$featured:!0,children:r.SEASONAL_CATEGORIES_ARR.map(({key:e,...a})=>(0,i.jsx)(o.CategoryCard,{...a,variant:"medium"},e))})]}),(0,i.jsxs)(g,{children:[(0,i.jsx)(x,{children:"Основные категории"}),(0,i.jsx)(f,{children:n.CATEGORIES_ARR.map(({key:e,...a})=>(0,i.jsx)(o.CategoryCard,{...a,variant:"medium"},e))})]}),(0,i.jsxs)(g,{children:[(0,i.jsx)(x,{children:"Еще идеи"}),(0,i.jsx)(f,{children:e.map(({key:e,...a})=>(0,i.jsx)(o.CategoryCard,{...a,variant:"medium"},e))})]})]})]})})}])}]);